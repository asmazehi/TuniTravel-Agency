...
bool fourniture::ajouter(){
    ...
    QString quantite_string=QString::number(quantite);
          query.prepare("INSERT INTO AV_FOURNITURE(REFERENCE,NOM,PRIX,QUANTITE,ETAT,FOURNISSEUR,IMAGE) "
...
query.prepare("Delete from AV_FOURNITURE where REFERENCE = :reference ");
...
model->setQuery("select * from AV_FOURNITURE");
...
bool fourniture::modifier(QString reference)
{
   ...
   QString res2= QString::number(quantite);
    query.prepare("UPDATE AV_FOURNITURE SET REFERENCE=:reference,nom=:nom,prix=:prix,quantite=:quantite,etat=:etat, fournisseur=:fournisseur, image=:image WHERE REFERENCE=:reference");
    query.bindValue(":reference", res);
    query.bindValue(":nom", nom);
...
{
    QPdfWriter pdf("C:/Users/Asma/OneDrive/Documents/2EME/ProjetQT/ProjetQT/fourniture.pdf");
...
painter.drawText(8500,12000,date);
                                ...
                                QSqlQuery query;
                                                         ...
                                                         query.prepare("select * from AV_FOURNITURE");
                                                         query.exec();
                                                         while (query.next())
                                                         {
...
QSqlQueryModel* fourniture::trierparref()
{
    ...
    model->setQuery("SELECT * FROM AV_FOURNITURE ORDER BY reference ASC");
    model->setHeaderData(0,Qt::Horizontal, QObject::tr("reference"));
    model->setHeaderData(1,Qt::Horizontal, QObject::tr("nom"));
    model->setHeaderData(2,Qt::Horizontal, QObject::tr("prix"));
    model->setHeaderData(3,Qt::Horizontal, QObject::tr("quantite"));
...
QSqlQueryModel* fourniture ::trierparnom()
{
    ...
    model->setQuery("SELECT * FROM AV_FOURNITURE ORDER BY nom ASC");
    model->setHeaderData(0,Qt::Horizontal, QObject::tr("reference"));
    model->setHeaderData(1,Qt::Horizontal, QObject::tr("nom"));
    model->setHeaderData(2,Qt::Horizontal, QObject::tr("prix"));
    model->setHeaderData(3,Qt::Horizontal, QObject::tr("quantite"));
...
QSqlQueryModel* fourniture::trierparpri()
{
    ...
    model->setQuery("SELECT * FROM AV_FOURNITURE ORDER BY prix ASC");
    model->setHeaderData(0,Qt::Horizontal, QObject::tr("reference"));
    model->setHeaderData(1,Qt::Horizontal, QObject::tr("nom"));
    model->setHeaderData(2,Qt::Horizontal, QObject::tr("prix"));
    model->setHeaderData(3,Qt::Horizontal, QObject::tr("quantite"));
...
QSqlQueryModel* fourniture::trierparqua()
{
    ...
    model->setQuery("SELECT * FROM AV_FOURNITURE ORDER BY quantite ASC");
    model->setHeaderData(0,Qt::Horizontal, QObject::tr("reference"));
    model->setHeaderData(1,Qt::Horizontal, QObject::tr("nom"));
    model->setHeaderData(2,Qt::Horizontal, QObject::tr("prix"));
    model->setHeaderData(3,Qt::Horizontal, QObject::tr("quantite"));
...
QSqlQueryModel* fourniture::trierpareta()
{
    ...
    model->setQuery("SELECT * FROM AV_FOURNITURE ORDER BY etat ASC");
    model->setHeaderData(0,Qt::Horizontal, QObject::tr("reference"));
    model->setHeaderData(1,Qt::Horizontal, QObject::tr("nom"));
    model->setHeaderData(2,Qt::Horizontal, QObject::tr("prix"));
    model->setHeaderData(3,Qt::Horizontal, QObject::tr("quantite"));
...
QSqlQueryModel* fourniture::trierparfou()
{
    ...
    model->setQuery("SELECT * FROM AV_FOURNITURE ORDER BY fournisseur ASC");
    model->setHeaderData(0,Qt::Horizontal, QObject::tr("reference"));
    model->setHeaderData(1,Qt::Horizontal, QObject::tr("nom"));
    model->setHeaderData(2,Qt::Horizontal, QObject::tr("prix"));
    model->setHeaderData(3,Qt::Horizontal, QObject::tr("quantite"));
...
bool fourniture::rechercheparref(QString reference)
    {
        ...
        query.prepare("SELECT * FROM AV_FOURNITURE WHERE REFERENCE=:reference");
    ...
    QSqlQueryModel *fourniture::afficherparref(QString reference)
        ...
        QSqlQuery *q = new QSqlQuery;
         q->prepare("SELECT * from AV_FOURNITURE where REFERENCE LIKE '%"+ref+"%'");
          q->addBindValue(ref);
           q->exec();
             model->setQuery(*q);
    ...
    QSqlQueryModel * fourniture::afficherenpanne(){
        QSqlQueryModel *model = new QSqlQueryModel();
     QSqlQuery q;
     q.prepare("SELECT * FROM AV_FOURNITURE where etat = :etat");
