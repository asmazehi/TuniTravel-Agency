...
void MainWindow::on_trii_toggled(bool checked)
{
    Offre off;
    if (checked==true)
    {
...
void MainWindow::on_Tric_toggled(bool checked)
{
    Offre off;
    if (checked==true)
    {
...
void MainWindow::on_trin_toggled(bool checked)
{
    Offre off;
    if (checked==true)
    {
...
void MainWindow::on_refreshButton_fire_clicked()
{
    click->play();
